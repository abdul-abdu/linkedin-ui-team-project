    ...
    return (
      <>
        <div className="profile-card col-12 col-lg-8">
          <p>
            Et aliqua occaecat ipsum reprehenderit eu quis officia incididunt
            adipisicing ea laborum sunt id. Ut sint est duis do aliqua laboris
            excepteur aliquip voluptate cillum. Commodo velit aliqua excepteur
            quis ullamco. Sit tempor qui anim et consequat pariatur. Ea nostrud
            amet laborum veniam nisi labore magna.
          </p>
